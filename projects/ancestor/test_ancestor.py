...
class Test(unittest.TestCase):
    ...
    def test_earliest_ancestor(self):
        test_ancestors = [(1, 3), (2, 3), (3, 6), (5, 6),
                          (5, 7), (4, 5), (4, 8), (8, 9), (11, 8), (10, 1), (20, 4), (25, 20)]
        ...
        self.assertEqual(earliest_ancestor(test_ancestors, 4), 25)
        self.assertEqual(earliest_ancestor(test_ancestors, 5), 25)
        self.assertEqual(earliest_ancestor(test_ancestors, 6), 25)
        self.assertEqual(earliest_ancestor(test_ancestors, 7), 25)
        self.assertEqual(earliest_ancestor(test_ancestors, 8), 25)
        self.assertEqual(earliest_ancestor(test_ancestors, 9), 25)
